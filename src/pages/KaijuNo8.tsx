  ...
  return (
    <div className="pt-16">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        >
          <source
            src="https://assets.mixkit.co/videos/preview/mixkit-dark-sunset-in-the-city-4121-large.mp4"
            type="video/mp4"
          />
        </video>
        <div className="relative z-20 h-full flex items-center justify-center text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-4 text-[#8CFBFA]">
              Kaiju No. 8 Collection
            </h1>
            <p className="text-xl text-gray-200">Unleash your inner monster with our defense force gear</p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div className="aspect-w-3 aspect-h-4">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <h3 className="text-2xl font-bold text-[#8CFBFA] mb-2">
                    {category.name}
                  </h3>
